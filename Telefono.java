...
public class Telefono extends Thread{
	...
	private synchronized void despertar() {
        ...
        public void mensajeNotifacion(){
            System.out.println("El telefono " + numero + " ha colgado");
            System.out.println("Piiiiiiiiii");
        }

        public synchronized void waitTelefono(){
            dormido = true;
            try{
                wait();
            }catch(InterruptedException e){}
